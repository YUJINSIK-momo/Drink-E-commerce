...
export default function ContactPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-12">
      ...
      <p className="text-gray-500 mb-10">{t.contact.description}</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
        ...
        <div className="space-y-4">
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            <h3 className="font-semibold text-gray-800 mb-4">{t.contact.sideCompany}</h3>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            <h3 className="font-semibold text-gray-800 mb-4">{t.contact.sideSns}</h3>
          ...
          <div className="bg-green-50 rounded-2xl p-6 border border-green-100">
            <h3 className="font-semibold text-green-800 mb-2 text-sm">{t.contact.sideHours}</h3>
            <p className="text-green-700 text-sm">{t.contact.sideWeekday}</p>
            <p className="text-green-600 text-xs mt-1">{t.contact.sideHolidayNote}</p>
          </div>
        </div>
      </div>
    </div>
